      ...
      <div className="space-y-8">
        {comments.map((comment) => (
          <div key={comment.id} className="flex gap-4 group">
            <div className="flex-shrink-0">
              <div className="h-10 w-10 rounded-xl flex items-center justify-center font-bold text-xs shadow-lg" style={{ backgroundColor: '#1c4f78', color: '#CCD0CF' }}>
            ...
            <div className="flex-grow space-y-1">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="font-bold text-sm" style={{ color: '#CCD0CF' }}>{comment.authorName || comment.author?.name || 'Campus Personnel'}</span>
                  <div 
              ...
              {editingCommentId === comment.id ? (
                ...
                <div 
                  className="p-4 rounded-2xl rounded-tl-none border text-sm leading-relaxed font-medium"
                  style={{ backgroundColor: 'rgba(37, 55, 69, 0.4)', borderColor: '#253745', color: '#9BA8AB' }}
                >
